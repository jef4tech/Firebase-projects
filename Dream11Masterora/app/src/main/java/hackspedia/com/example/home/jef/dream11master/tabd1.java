...
public class tabd1 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate( R.layout.tabe1, container, false );
        ...
        imageRef = storageRef.child("images/footballB1");
    ...
    public void fetch() {
        imageRef.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
            ...
            public void onSuccess(Uri uri) {
                ...
                Glide.with(tabd1.this).load(uri.toString()).thumbnail(0.1f).into(mImageView);
