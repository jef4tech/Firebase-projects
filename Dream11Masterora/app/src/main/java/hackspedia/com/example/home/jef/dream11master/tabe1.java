...
public class tabe1 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate( R.layout.tabf1, container, false );
        ...
        imageRef = storageRef.child("images/footballC1");
    ...
    public void fetch() {
        imageRef.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
            ...
            public void onSuccess(Uri uri) {
                ...
                Glide.with(tabe1.this).load(uri.toString()).thumbnail(0.1f).into(mImageView);
